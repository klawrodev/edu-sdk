...
Set on `.edu-quiz`: `--edu-quiz-background`, `--edu-quiz-foreground`, `--edu-quiz-text`, `--edu-quiz-muted`, `--edu-quiz-border`, `--edu-quiz-option-background`, `--edu-quiz-option-hover`, `--edu-quiz-selected-background`, `--edu-quiz-selected-border`, `--edu-quiz-correct-background`, `--edu-quiz-correct-border`, `--edu-quiz-correct-foreground`, `--edu-quiz-incorrect-background`, `--edu-quiz-incorrect-border`, `--edu-quiz-incorrect-foreground`, `--edu-quiz-radius`.
...
Set on `.edu-study-session`: `--edu-study-session-background`, `--edu-study-session-foreground`, `--edu-study-session-muted`, `--edu-study-session-border`, `--edu-study-session-button-background`, `--edu-study-session-button-hover`, `--edu-study-session-radius`.
